...
$sql = "SELECT Employee.Id as EmpID, concat(FirstName, ' ', LastName) as Name, EmployeeType.Name as Job, Employee.HireDate
 FROM Employee JOIN EmployeeType ON Employee.EmployeeTypeID = EmployeeType.ID
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td> " . $row["EmpID"] . " </td><td> " . $row["Name"] . "</td><td> " . $row["Job"] . "</td><td>" . $row["HireDate
"] . "</td></tr>";
    }
} else {
    echo "0 results";
