...
$sql = "SELECT * FROM Patient JOIN PatientAdmission ON Patient.Id = PatientAdmission.PatientId 
JOIN PatientDiagnosis ON PatientDiagnosis.PatientAdmissionId = PatientAdmission.PatientId
JOIN DiagnosisType ON DiagnosisType.Id = PatientDiagnosis.DiagnosisTypeId
 GROUP BY Patient.Id;";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td> " . $row["FirstName"] . " </td><td> " . $row["LastName"] . " </td><td>  " . $row["Name"];
