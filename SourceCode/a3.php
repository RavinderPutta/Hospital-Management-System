...
$sql = "Select Room.Number, Patient.FirstName, Patient.LastName, PatientAdmission.AdmissionTime  from Room left join Patient on Room.PatientId = Patient.Id left join PatientAdmission on PatientAdmission.PatientId = Patient.Id where Room.PatientId IS NULL OR (AdmissionTypeId = 2 AND DischargeTime IS NULL);
";
